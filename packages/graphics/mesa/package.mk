...
post_make_target() {
  mkdir -p $SYSROOT_PREFIX/usr/lib
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/libEGL.s* $SYSROOT_PREFIX/usr/lib/.
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/libgbm.s* $SYSROOT_PREFIX/usr/lib/.
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/libGL.s* $SYSROOT_PREFIX/usr/lib/.
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/libglapi.s* $SYSROOT_PREFIX/usr/lib/.
}
