...
post_make_target() {
    mkdir -p $SYSROOT_PREFIX/usr/lib
      cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/.libs/libdrm.s* $SYSROOT_PREFIX/usr/lib/.
}

post_makeinstall_target() {
    mkdir -p $SYSROOT_PREFIX/usr/lib
      cp -P $INSTALL/usr/lib/libdrm_i* $SYSROOT_PREFIX/usr/lib/.
      cp -P $INSTALL/usr/lib/libkms* $SYSROOT_PREFIX/usr/lib/.
}
