...
PKG_LICENSE="GPL"
PKG_SITE="https://github.com/lathiat/avahi"
PKG_URL="https://github.com/lathiat/avahi/archive/$PKG_VERSION.tar.gz"
PKG_SOURCE_DIR=""
...
post_make_target() {
  mkdir -p $SYSROOT_PREFIX/usr/lib
    cp -P $ROOT/$PKG_BUILD/avahi-core/.libs/libavahi-core.s* $SYSROOT_PREFIX/usr/lib/.
    cp -P $ROOT/$PKG_BUILD/avahi-common/.libs/libavahi-common.s* $SYSROOT_PREFIX/usr/lib/.
}
