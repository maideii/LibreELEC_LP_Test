...
post_make_target() {
    mkdir -p $SYSROOT_PREFIX/usr/lib
      cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/libiptc/.libs/libip4tc.s* $SYSROOT_PREFIX/usr/lib/.
      cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/libiptc/.libs/libip6tc.s* $SYSROOT_PREFIX/usr/lib/.
      cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/libiptc/.libs/libiptc.s* $SYSROOT_PREFIX/usr/lib/.
      cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/libxtables/.libs/libxtables.s* $SYSROOT_PREFIX/usr/lib/.
}
