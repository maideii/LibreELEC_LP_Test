...
post_make_target() {
  mkdir -p $SYSROOT_PREFIX/usr/lib
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/.libs/libirrecord.s* $SYSROOT_PREFIX/usr/lib
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/.libs/liblirc.s* $SYSROOT_PREFIX/usr/lib
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/.libs/liblirc_client.s* $SYSROOT_PREFIX/usr/lib
    cp -P $ROOT/$PKG_BUILD/.$TARGET_NAME/lib/.libs/liblirc_driver.s* $SYSROOT_PREFIX/usr/lib
}
