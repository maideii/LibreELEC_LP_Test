...
post_makeinstall_target() {
  ...
  mkdir -p $SYSROOT_PREFIX/usr/lib
    cp -P $INSTALL/usr/lib/libpulse.s* $SYSROOT_PREFIX/usr/lib/.
    cp -P $INSTALL/usr/lib/libpulse-simple.s* $SYSROOT_PREFIX/usr/lib/.
    cp -P $INSTALL/usr/lib/libpulse-mainloop-glib.s* $SYSROOT_PREFIX/usr/lib/.
}
